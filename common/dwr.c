...
static BOOL dwr_init(dw_rom *rom, const char *input_file, char *flags)
{
    ...
    rom->spike_table = (dwr_spike_table*)&rom->content[SPIKE_TABLE];
...
//     dwr_str_replace(rom, "The spell will not work", "The spell had no effect");
    ...
    add_hook(rom, JMP, 0xFAEF, LOAD_AUTOSAVE);
    vpatch(rom, 0xF987, 1, 0x3); /* don't allow new game in slot 3 */
    /* ADVENTURE LOG 3 -> AUTO SAVE */
    vpatch(rom, 0x7322, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
    vpatch(rom, 0x734B, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
    vpatch(rom, 0x7374, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
    vpatch(rom, 0x73AE, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
    vpatch(rom, 0x7454, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
    vpatch(rom, 0x7481, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
    vpatch(rom, 0x74C1, 16, 0x81, 0x24, 0x38, 0x37, 0x32, 0x5f, 0x36, 0x24,
            0x39, 0x28, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81, 0x81);
}
