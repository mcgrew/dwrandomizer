...
static void credits(dw_rom *rom)
{
    ...
    vpatch(rom, 0x05834, 205,
            0x63, 0x20,  /* Write PPU Address 2063 */
            /* D     R     A     G     O     N        */
            ...
            0xfc, 0xc3, 0x20,  /* Write PPU Address 20C3 */
            /* D     E     V     E     L     O     P     E     R */
            0x27, 0x28, 0x39, 0x28, 0x2f, 0x32, 0x33, 0x28, 0x35,

            0xfc, 0xd7, 0x20,  /* Write PPU Address 20D7 */
            /* M     C     G     R     E     W */
            0x30, 0x26, 0x2a, 0x35, 0x28, 0x3a,
            
            0xfc, 0x23, 0x21,  /* Write PPU Address 2123 */
            /* C     O     N     T     R     I     B     U     T     O     R */
            0x26, 0x32, 0x31, 0x37, 0x35, 0x2c, 0x25, 0x38, 0x37, 0x32, 0x35,
            /* S */
            0x36,

            0xfc, 0x34, 0x21,  /* Write PPU Address 2134 */
            /* G     A     M     E     B     O     Y     F     9 */
            0x2a, 0x24, 0x30, 0x28, 0x25, 0x32, 0x3c, 0x29, 0x09,

            0xfc, 0x74, 0x21,  /* Write PPU Address 2174 */
            /* C     A     I     T     S     I     T     H     2 */
            0x26, 0x24, 0x2c, 0x37, 0x36, 0x2c, 0x37, 0x2b, 0x02,

            0xfc, 0xba, 0x21,  /* Write PPU Address 21BA */
            /* D     V     J */
            0x27, 0x39, 0x2d,

            0xfc, 0xf3, 0x21,  /* Write PPU Address 21F3 */
            /* B     U     N     D     E     R     2     0     1     5 */
            0x25, 0x38, 0x31, 0x27, 0x28, 0x35, 0x02, 0x00, 0x01, 0x05,

            0xfc, 0x37, 0x22,  /* Write PPU Address 2237 */
            /* D     W     E     D     I     T */
            0x27, 0x3a, 0x28, 0x27, 0x2c, 0x37,

            0xfc, 0x83, 0x22,  /* Write PPU Address 2283 */
            /* S     P     R     I     T     E           W     O     R     K */
            0x36, 0x33, 0x35, 0x2c, 0x37, 0x28, 0x5f, 0x3a, 0x32, 0x35, 0x2e,

            0xfc, 0x95, 0x22,  /* Write PPU Address 2295 */
            /* X     A     R     N     A     X     4     2 */
            0x3b, 0x24, 0x35, 0x31, 0x24, 0x3b, 0x04, 0x02,

            0xfc, 0xd3, 0x22,  /* Write PPU Address 22D3 */
            /* R     Y     U     S     E     I     S     H     I     N */
            0x35, 0x3c, 0x38, 0x36, 0x28, 0x2c, 0x36, 0x2b, 0x2c, 0x31,

            0xfc, 0x17, 0x23,  /* Write PPU Address 2317 */
            /* M     C     G     R     E     W */
            0x30, 0x26, 0x2a, 0x35, 0x28, 0x3a,

            0xfc, 0x20, 0x23,  /* Write PPU Address 2320 */
            /* Write a bunch of space characters (just to fill ROM space) */
            ...
            0x04, 0x55, 0xf7, 0x14, 0xaa, 0xf7, 0x04, 0x55, 0xf7, 0x0c);
}
