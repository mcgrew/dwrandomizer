...
#define RANDOM_MAP_SIZE(x)        (x->flags[14] & 0x0c)
...
#define MODERN_SPELLS(x)          (x->flags[10] & 0xc0)
#define NOIR_MODE(x)              (x->flags[10] & 0x30)
