...
typedef enum {
    ...
    DUNGEON_TILE_BLACK,
    DUNGEON_TILE_BLOCK_2,
    DUNGEON_TILE_STAIRS_UP_2,
    DUNGEON_TILE_BRICK_2, /* 10 */
    DUNGEON_TILE_STAIRS_DOWN_2,
    DUNGEON_TILE_CHEST_2,
    DUNGEON_TILE_DOOR_2,
    DUNGEON_TILE_GWAELIN_2,
    DUNGEON_TILE_BLACK_2, /* 15 */
} dw_dungeon_tile;
