...
#define JMP_SNAPSHOT_TIMER(addr) vpatch(rom, addr, 3, 0x4C, 0xC1, 0xC3)
#define JSR_SNAPSHOT_TIMER(addr) vpatch(rom, addr, 3, 0x20, 0xC1, 0xC3)
#define DHOOK_SNAPSHOT_TIMER(addr) vpatch(rom, addr, 4, 0x20, 0xC1, 0xC3, 0xea)
