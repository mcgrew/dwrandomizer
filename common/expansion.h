...
enum subroutine {
  ...
  COUNT_FRAME = 0xC426,
  SNAPSHOT_TIMER = 0xC455,
  LOAD_AUTOSAVE = 0xC463,
  DO_AUTOSAVE = 0xC475,
  MODIFY_RUN_RATE = 0xC48D,
  SCALE_MSLIME_XP = 0xC49D,
  SAVE_CURRENT_SPELLS = 0xC4B5,
  CHECK_FLUTE_ENEMY = 0xC4C0,
  FLUTE_ENEMY_TABLE = 0xC4CF,
  SPIKE_MAP = 0xCD7A,
  SPIKE_TABLE = 0xCD7A,
  SPIKE_X = 0xCD82,
  SPIKE_Y = 0xCD8A,
  ...
  CREDIT_MUSIC_PPU_1 = 0x6CBE,
  CREDIT_MUSIC_PPU_2 = 0x6CC2,
  CREDIT_MUSIC_PPU_3 = 0x6CC6,
  CREDIT_MUSIC_SLOT_1 = 0x6CDA,
  CREDIT_MUSIC_SLOT_2 = 0x6CF9,
  CREDIT_MUSIC_SLOT_3 = 0x6D18,
  CREDIT_MUSIC_SLOT_4 = 0x6D37,
  CREDIT_MUSIC_SLOT_5 = 0x6D56,
  CREDIT_MUSIC_SLOT_6 = 0x6D75,
  CREDIT_MUSIC_SLOT_7 = 0x6D94,
  CREDIT_MUSIC_SLOT_8 = 0x6DB3,
  CREDIT_MUSIC_SLOT_9 = 0x6DD2,
};
