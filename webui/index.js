...
function setup_ui() {
    ...
    ui.addTriOption('Monsters', 0, 5, 0, 'Random Monster Abilities');
    ui.addTriOption('Monsters', 2, 5, 0, 'Random Monster Zones');
    ui.addTriOption('Monsters', 4, 5, 0, 'Random Monster Stats');
    ...
    // leveling speed
    ui.addDropDown('Shortcuts', 1, 8, 4, 'Leveling Speed: ', {
        'Normal' : 0,
        'Fast' : 1,
        'Very Fast': 2
    });

    ui.addTriOption('Challenge', 0, 9, 0, 'No Hurtmore');
    ui.addTriOption('Challenge', 2, 9, 0, 'No Numbers');
    ui.addTriOption('Challenge', 4, 9, 0, 'Invisible Hero');
    ui.addTriOption('Challenge', 6, 9, 0, 'Invisible NPCs');

    ui.addTriOption('Goals', 0, 8, 4, 'Cursed Princess');
    ui.addTriOption('Goals', 2, 8, 2, "Three's Company");

    ui.addOption('Cosmetic', 0, 9, 7, 'Shuffle Music');
    ui.addOption('Cosmetic', 2, 9, 6, 'Disable Music');
    ui.addOption('Cosmetic', 4, 9, 5, 'Modern Spell Names');
    ui.addOption('Cosmetic', 6, 9, 4, 'Noir Mode');
    ui.addOption('Cosmetic', 8, 9, 3, 'Disable Spell Flashing');
